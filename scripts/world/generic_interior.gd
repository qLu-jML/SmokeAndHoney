...
## Initialize the interior: walls, scene info, player placement.
func _ready() -> void:
...
## Build collision shapes for the room walls.
...
## Add a collision shape to the StaticBody2D.
...
## Handle input for ESC key to exit.
...
## Check for player door exit each frame.
